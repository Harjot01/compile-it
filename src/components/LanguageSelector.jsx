...
const LanguageSelector = () => {
  ...
  return (
    <Listbox value={language} onChange={onSelectLanguage}>
      <div className="relative w-48 ml-1 h-full flex bg-[#1c2130]">
        <ListboxButton
          className="text-white relative w-full cursor-pointer rounded-md  py-1.5 pl-3 pr-10 shadow-sm  ring-inset  focus:outline-none  sm:text-sm sm:leading-6"
          style={{ backgroundColor: themeColors }}
        >
          <span className="flex items-center">
            <span className="ml-3 block truncate text-lg">{language}</span>
          </span>
